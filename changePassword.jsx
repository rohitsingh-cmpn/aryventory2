...
import { faAngleLeft, faAngleRight, faEye, faEyeSlash, faLock } from '@fortawesome/free-solid-svg-icons'; // Import faEye and faEyeSlash
import padlock from '../../../assets/padlock.svg'; // Assuming you have a padlock icon
        ...
        <div className='w-full h-full bg-white'>
            ...
            <div className="flex flex-col w-full lg:w-[60%] rounded-xl bg-white">
                ...
                <form className="w-full space-y-6 p-6">
                    <div className="mb-6 relative"> {/* Added relative to parent div */}
                        ...
                        <div className="relative">
                            ...
                            >
                                <FontAwesomeIcon className='text-gray-500' icon={showCurrent ? faEyeSlash : faEye} /> {/* Use FontAwesomeIcon component */}
                            </button>
                        </div>
                    </div>
                    <div className="mb-6 relative"> {/* Added relative to parent div */}
                        ...
                        <div className="relative">
                            ...
                            >
                                <FontAwesomeIcon className='text-gray-500'  icon={showNew ? faEyeSlash : faEye} /> {/* Use FontAwesomeIcon component */}
                            </button>
                        </div>
                    </div>
                    <div className="mb-6 relative"> {/* Added relative to parent div */}
                        ...
                        <div className="relative">
                            ...
                            >
                                <FontAwesomeIcon className='text-gray-500'  icon={showConfirm ? faEyeSlash : faEye} /> {/* Use FontAwesomeIcon component */}
                            </button>
                        </div>
                    </div>
