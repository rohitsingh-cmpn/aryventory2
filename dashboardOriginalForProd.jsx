...
const CardFinal=(cards)=> {
  return  <Card className="bg-[#FFFFFF] col-span-1 lg:col-span-2">
                <CardContent className="flex p-5 w-full h-full">
                  ...
                  <div className=" flex flex-col gap-5 lg:min-gap-5 justify-between ">
                    ...
                    <FontAwesomeIcon icon={faArrowUp} className="md:text-xl p-2 aspect-square text-md text-[#888888] rotate-45"/>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className=" flex gap-3">
                    ...
                    <div className="bg-[#F89320] rounded-xl h-fit flex p-1 py-1 relative">
                      ...
                      <div className="pointer-events-none text-white right-[10%] top-[20%] absolute">
                        <FontAwesomeIcon className="p-0" icon={IsOpenLine ? faAngleUp : faAngleDown} />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between px-2 mx-4 mb-3 py-1">
                  ...
                  <div className=" flex gap-3">
                    ...
                    <div className="bg-[#F89320] rounded-xl h-fit flex p-1 py-1  relative">
                      ...
                      <div className="pointer-events-none text-white right-[10%] top-[20%] absolute">
                        <FontAwesomeIcon className="p-0" icon={IsOpenBar ? faAngleUp : faAngleDown} />
                      </div>
                    </div>
                  </div>
                </div>
...
//   return (
//     <div className="bg-[#F6F6F6] p-4 w-full h-[calc(100vh-65px)] overflow-y-auto">
//       <main className="grid lg:grid-rows-5 grid-rows-[13] w-full h-full gap-5">
//         <div className="grid grid-cols-4 w-full lg:row-span-1 row-span-3  gap-4">
//           {statCards.map((stat, index) => (
//             <Card
//               key={index}
//               className="bg-[#FFFFFF] flex w-full py-1 px-4 col-span-2 lg:col-span-1 h-full overflow-hidden"
//             >
...
//         <div className="w-full h-full  flex  lg:row-span-2 row-span-5  ">
//           <div className="  grid grid-cols-4 w-full h-full gap-5">
//             <div className="flex w-full h-full lg:col-span-3 col-span-4 min-h-[300px]">
//               <Card className="bg-[#FFFFFF] flex flex-col w-full py-4 h-full ">
//                 <div className="flex justify-between px-2 mx-4 mb-3 py-1">
...
//         <div className="flex  lg:row-span-2 row-span- w-full h-full">
//           <div className="grid grid-cols-4  w-full h-full gap-5">
//             {/* Left Column */}
//             <div className="grid grid-cols-2 w-full h-full lg:col-span-1 col-span-4 gap-5 ">
//               {/* In hand Card */}
