...
const PrivacyPolicy = () => {
  const policyData = {
    intro: "Your privacy is important to us. This Privacy Policy explains how we handle your data in accordance with data protection laws such as the General Data Protection Regulation (GDPR).",
    sections: [
      {
      ...
      },
      {
        ...
        content: "Your data is securely stored using industry-standard measures. We ensure that all information is protected from unauthorized access, disclosure, or destruction."
      },
      {
        title: "4. Third-Party Sharing",
        content: "We do not share your personal data with any third parties. Your information stays with us and is used only for purposes related to the app's functionality."
      },
      {
        title: "5. Payment and Financial Data",
        content: "We do not store any payment or personal financial data. All payment transactions are handled by secure, compliant third-party payment processors."
      }
    ],
    contact: "For any questions or concerns about your privacy, please reach out to us at: contact@aryventory.com"
  };
        ...
        <div className="p-4 md:p-8">
          ...
          <div className="space-y-6">
            {policyData.sections.map((section, index) => (
              <div key={index} className="bg-gray-50 p-4 rounded-lg">
                ...
                {section.note && <p className="text-gray-600 mt-4">{section.note}</p>}
              </div>
            ))}
          </div>
          ...
          <footer className="mt-8 pt-4 border-t border-gray-200 text-center">
            <p className="text-gray-600">
              ...
              <a href="mailto:contact@aryventory.com" className="text-blue-600 hover:underline">
