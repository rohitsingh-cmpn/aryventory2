...
function FeedBack() {
  ...
  return (
    <div className="h-full w-full bg-white rounded-2xl shadow-lg p-6 flex flex-col space-y-6">
      ...
      <div>
        <h3 className="text-2xl font-semibold text-gray-800">Rate your Experience</h3>
        <p className="text-gray-600 mt-1">Are you satisfied with the service?</p>
      </div>
...
<hr className="w-full border-t border-gray-300 my-4" />
      ...
      <div className="relative flex flex-col">
        ...
        <p className="text-sm text-gray-500 mt-1">
          How do you continue to manage your inventory? Share your challenges with us! Your feedback could help us create the perfect solution for inventory management.
        </p>
      </div>
