  ...
  return (
    <div className="w-full h-full bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center space-y-4 sm:mx-auto">
      ...
      <div className="text-sm text-gray-700 mt-2 space-y-2 text-left">
        ...
        <p>• Make sure to keep your app up-to-date for the latest features, bug fixes, and security improvements.</p>
      </div>

      {/* What's New */}
      <div className="w-full mt-4 pt-4 border-t border-gray-200 text-left">
        <h3 className="text-base font-semibold text-gray-800 mb-2">What’s New?</h3>
        <p className="text-sm text-gray-700">• Initial release with basic inventory management functionality.</p>
      </div>
    </div>
  )
}
